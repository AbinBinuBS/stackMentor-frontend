...
const MentorRoutes = () => {
	return (
		<Routes>
			<Route
				path="/"
				element={<MentorProtectiveCheckLogout element={<MentorLoginPage />} />}
			/>
			<Route
				path="/register"
				element={
					<MentorProtectiveCheckLogout element={<MentorRegisterPage />} />
				}
			/>
			<Route
				path="/otp"
				element={<MentorProtectiveCheckLogout element={<MentorOtpPage />} />}
			/>
			<Route
				path="/forgot-password"
				element={
					<MentorProtectiveCheckLogout
						element={<MentorForgotPasswordEmailPage />}
					/>
				}
			/>
			<Route
				...
				element={
					<MentorProtectiveCheckLogout
						element={<MentorForgotPasswordOtpPage />}
					/>
				}
			/>
			<Route
				...
				element={
					<MentorProtectiveCheckLogout
						element={<MentorForgotPasswordResetPage />}
					/>
				}
			/>
			<Route
				path="/home"
				element={<MentorProtectiveCheck element={<MentorHomePage />} />}
			/>
			<Route
				path="/verify"
				element={<MentorProtectiveCheck element={<MentorVerifyPage />} />}
			/>
			<Route
				path="/account"
				element={<MentorProtectiveCheck element={<MentorAccountPage />} />}
			/>
			<Route
				path="/schedule-time"
				element={<MentorProtectiveCheck element={<MentorSheduleTimePage />} />}
			/>
			<Route
				path="/my-slot"
				element={<MentorProtectiveCheck element={<MentorMySlotPage />} />}
			/>
			<Route
				path="/booked-slot"
				element={<MentorProtectiveCheck element={<MentorBookedSlotsPage />} />}
			/>
			<Route
				path="/chat"
				element={<MentorProtectiveCheck element={<MentorChatPage />} />}
			/>
			<Route
				path="/room/:roomId"
				element={<MentorProtectiveCheck element={<RoomPage />} />}
			/>
			<Route
				path="/qa"
				element={<MentorProtectiveCheck element={<QAPage />} />}
			/>
			<Route
				path="/community-meet"
				element={<MentorProtectiveCheck element={<CommunityMeetPage />} />}
			/>
			<Route
				path="/my-community-meet"
				element={<MentorProtectiveCheck element={<MyCommunityPage />} />}
			/>
			<Route
