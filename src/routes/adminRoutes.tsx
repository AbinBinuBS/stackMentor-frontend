...
const AdminRoutes = () => {
	return (
		<Routes>
			<Route
				path="/"
				element={<AdminProtectiveCheckLogout element={<AdminLogin />} />}
			/>
			<Route
				path="/dashboard"
				element={<AdminProtectiveCheck element={<AdminDashboardPage />} />}
			/>
			<Route
				path="/mentor-list"
				element={<AdminProtectiveCheck element={<AdminMentorListPage />} />}
			/>
			<Route
				path="/mentor-details/:id"
				element={<AdminProtectiveCheck element={<AdminMentorSinglePage />} />}
			/>
			<Route
				path="/users"
				element={<AdminProtectiveCheck element={<AdminUserListPage />} />}
			/>
			<Route
				path="/qa"
				element={<AdminProtectiveCheck element={<AdminQAPage />} />}
			/>
			<Route
				path="/community-meet"
				element={<AdminProtectiveCheck element={<AdminCommunityMeetPage />} />}
			/>
		</Routes>
	);
};
