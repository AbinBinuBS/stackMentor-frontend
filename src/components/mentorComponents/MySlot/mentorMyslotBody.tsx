    ...
    const getSlots = async () => {
        try {
            ...
            const response = await apiClient.get(
                `${LOCALHOST_URL}/api/mentor/getSlots?page=${currentPage}&limit=${slotsPerPage}${dateParam ? `&date=${dateParam}` : ''}`
            );
            ...
            if (response.data.message === "Slots sent successfully") {
                ...
                setTotalPages(Math.ceil(response.data.totalCount / slotsPerPage));
            } else {
        ...
        if (result.isConfirmed) {
            try {
                ...
                if (response.data.message === "Slots deleted successfully") {
                    ...
                    getSlots(); // Refresh the slots after deletion
