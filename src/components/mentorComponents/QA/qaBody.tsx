...
import { IQuestion } from "../../../interfaces/mentorInterfaces";
...
const QABody: React.FC = () => {
	...
	const [activeTab, setActiveTab] = useState<"unanswered" | "myAnswers">(
		"unanswered"
	);
			...
			<div className="flex flex-col justify-center items-center ">
				<div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-md text-center mt-36 mr-4 ml-4">
					...
					<p className="text-gray-700 mb-4">
						Please complete the verification process to access your booked
						slots.
					</p>
					<button
						onClick={() => {
