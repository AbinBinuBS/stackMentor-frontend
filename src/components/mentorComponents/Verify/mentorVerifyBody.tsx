...
import { MentorVerifyFormValues, Stack } from "../../../interfaces/mentorInterfaces";
...
const MentorVerifyBody: React.FC = () => {
  ...
  const renderDropdownField = (name: string, label: string, options: string[]) => (
    <div className="mb-2">
      <label
        htmlFor={name}
        className="block text-xs font-medium text-gray-700 mb-1"
  ...
  const stackOptions: Stack[] = [
    "Python", "MERN", "Data Science", "Java", "DevOps", "Cloud Computing", 
    "Mobile Development", "Machine Learning", "Blockchain", "UI/UX Design", 
    "Cybersecurity", "Game Development", "AR/VR", "IoT", "Embedded Systems"
  ];
  ...
  const formSections = [
    ...
    },
    {
      ...
      fields: [
        ...
        renderInputField("lastWorkedCompany", "Last Worked Company"),
        renderInputField("yearsOfExperience", "Years of Experience", "number"),
        renderDropdownField("stack", "Stack", stackOptions),
      ],
    },
    {
      title: "Documents",
