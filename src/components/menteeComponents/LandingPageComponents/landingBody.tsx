        ...
        <>
            <div className="pt-16 lg:pt-20">
                ...
                <div className="flex flex-col lg:flex-row items-center justify-around w-full h-auto my-16 p-6 lg:p-12">
                    <a href="/find-mentor" className="w-full lg:w-80 h-44 bg-teal-100 flex items-center justify-center rounded-lg shadow-md mb-4 lg:mb-0">
                        <i className="fa-solid fa-user-tie text-4xl mx-4 text-teal-800"></i>
                        <h2 className="text-xl text-teal-900">Find a Mentor</h2>
                    </a>
                    <a href="/skill-development" className="w-full lg:w-80 h-44 bg-teal-100 flex items-center justify-center rounded-lg shadow-md mb-4 lg:mb-0">
                        <i className="fa-solid fa-laptop-code text-4xl mx-4 text-teal-800"></i>
                        <h2 className="text-xl text-teal-900">Skill Development</h2>
                    </a>
                    <a href="/career-guidance" className="w-full lg:w-80 h-44 bg-teal-100 flex items-center justify-center rounded-lg shadow-md">
                ...
                <div className="flex flex-col lg:flex-row items-center justify-between w-full h-auto my-16 p-6 lg:p-12 bg-teal-50 rounded-lg">
                    <div className="flex-1 lg:w-1/2 px-4 lg:px-8">
                        <h1 className="text-2xl lg:text-4xl font-bold mb-4 text-teal-900">Unlock Your Potential with Expert Guidance</h1>
                ...
                <div className="px-4 lg:px-16 py-10">
                    <div className="text-center mb-10">
                        <h1 className="text-3xl lg:text-4xl font-bold text-teal-900">Ways to Make the Most of Your Mentorship</h1>
                    </div>
                    <div className="flex flex-col lg:flex-row justify-center gap-8">
                        <div className="w-full lg:w-[350px] h-auto bg-teal-100 rounded-xl p-6 shadow-md mt-4 md:mt-8">
                            <h2 className="text-xl lg:text-2xl font-semibold mb-4 text-teal-900">Personalized Mentoring</h2>
                            <p className="text-base lg:text-lg text-teal-800">
                        ...
                        <div className="w-full lg:w-[350px] h-auto bg-teal-50 rounded-xl p-6 shadow-md mt-4 md:mt-8">
                            <h2 className="text-xl lg:text-2xl font-semibold mb-4 text-teal-900">Skill Enhancement</h2>
                            <p className="text-base lg:text-lg text-teal-800">
                    ...
                    <div className="flex flex-col lg:flex-row justify-center gap-8 mt-10">
                        <div className="w-full lg:w-[350px] h-auto bg-teal-100 rounded-xl p-6 shadow-md mt-4 md:mt-8">
                            <h2 className="text-xl lg:text-2xl font-semibold mb-4 text-teal-900">Career Path Guidance</h2>
                            <p className="text-base lg:text-lg text-teal-800">
                                Receive strategic advice on navigating your career path and making informed decisions for your future.
                            </p>
                        </div>
                        <div className="w-full lg:w-[350px] h-auto bg-teal-50 rounded-xl p-6 shadow-md mt-4 md:mt-8">
                            <h2 className="text-xl lg:text-2xl font-semibold mb-4 text-teal-900">Professional Growth</h2>
                            <p className="text-base lg:text-lg text-teal-800">
