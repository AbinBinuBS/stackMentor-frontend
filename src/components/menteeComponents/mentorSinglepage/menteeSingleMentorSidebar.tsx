...
const MenteeSingleMentorSidebar: React.FC<MenteeSingleMentorSidebarProps> = ({mentor}) => {
        ...
        <div className="w-64 ml-6">
            <div className="bg-white rounded-lg shadow-md p-6">
                <div className="flex flex-col items-center">
                    ...
                    <p className="text-sm text-gray-600 mb-4 text-center">{mentor?.yearsOfExperience} years of experience.</p>
