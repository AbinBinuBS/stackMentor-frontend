...
const QABody: React.FC = () => {
	...
	const [selectedQuestion, setSelectedQuestion] = useState<IQaData | null>(
		null
	);
	...
	const filteredQuestions = questions.filter(
		(question) =>
			...
			question.menteeId?.name
				.toLowerCase()
				.includes(searchQuery.toLowerCase()) ||
			(question.mentorId?.name &&
				question.isAnswered &&
				question.mentorId.name
					.toLowerCase()
					.includes(searchQuery.toLowerCase())) // Search by mentor name if answered
	);
